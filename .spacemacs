...
;; ----------------------------------------------------------------
   ...
   dotspacemacs-additional-packages '(iflipb)
...
you should place your code here."
  ;; Set modifier keys
  (setq mac-command-modifier 'meta) ;; Bind cmd to meta
  (setq mac-option-modifier 'super) ;; Bind option to super
